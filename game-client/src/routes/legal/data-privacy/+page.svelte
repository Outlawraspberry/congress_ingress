...
<Breadcrump />
<section class="prose">
	<h1 class="title">Datenschutz&shy;erkl&auml;rung</h1>

	<h2 class="title is-2">1. Datenschutz auf einen Blick</h2>

	<h3 class="title is-3">Allgemeine Hinweise</h3>
	...
	<h3 class="title is-3">Datenerfassung auf dieser Website</h3>

	<h4 class="title is-4">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4>
	...
	<h4 class="title is-4">Wie erfassen wir Ihre Daten?</h4>
	...
	<h4 class="title is-4">Wof&uuml;r nutzen wir Ihre Daten?</h4>
	...
	<h4 class="title is-4">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
	...
	<h2 class="title is-2">2. Hosting</h2>

	<p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>

	<h3 class="title is-3">IONOS</h3>
	...
	<h3 class="title is-3">Supabase</h3>

	<p>
		Wir nutzen den Dienst Supabase der Supabase Inc. als Backend‑Plattform für unsere Anwendung
		(z.B. Datenbank, Authentifizierung und Dateispeicher). Beim Besuch und bei Nutzung unserer
		Website/Anwendung werden dort insbesondere technische Nutzungsdaten (z.B. IP‑Adresse, Datum und
		Uhrzeit der Anfrage, verwendeter Browser und Betriebssystem) verarbeitet, um die Bereitstellung
		und Sicherheit unseres Online‑Angebots zu gewährleisten. Details entnehmen Sie der
	...
	<p>
		Die Verwendung von Supabase erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Unser
		berechtigtes Interesse besteht in der technisch sicheren, effizienten und skalierbaren
		Bereitstellung unserer Website bzw. Anwendung. Sofern eine entsprechende Einwilligung abgefragt
		wurde (z.B. für optionale Tracking‑ oder Analysefunktionen), erfolgt die Verarbeitung
		ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG; die
		Einwilligung ist jederzeit widerrufbar.
	</p>

	<h2 class="title is-2">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>

	<h3 class="title is-3">Datenschutz</h3>
	...
	<h3 class="title is-3">Hinweis zur verantwortlichen Stelle</h3>

	<p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p>

	<p>Outlawraspberry UG (haftungsbeschr&auml;nkt)</p>
	...
	<h3 class="title is-3">Speicherdauer</h3>
	...
	<h3 class="title is-3">Empfänger von personenbezogenen Daten</h3>
	...
	<h3 class="title is-3">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
	...
	<h3 class="title is-3">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
	...
	<h3 class="title is-3">Auskunft, Berichtigung und L&ouml;schung</h3>
	...
	<h3 class="title is-3">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
	...
	<h2 class="title is-2">4. Plugins und Tools</h2>

	<h3 class="title is-3">Font Awesome (lokales Hosting)</h3>
