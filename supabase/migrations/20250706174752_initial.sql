...
GRANT ALL ON ALL TABLES IN SCHEMA game TO anon,
authenticated,
service_role;

GRANT ALL ON ALL ROUTINES IN SCHEMA game TO anon,
authenticated,
service_role;

GRANT ALL ON ALL SEQUENCES IN SCHEMA game TO anon,
authenticated,
service_role;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA game GRANT ALL ON ROUTINES TO anon,
authenticated,
service_role;
