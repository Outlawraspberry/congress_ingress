...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      get_floor_coordinate_info: {
        Args: { p_floor_id: number }
        Returns: {
          coordinate_info: string
          floor_id: number
          floor_name: string
          image_height: number
          image_width: number
      ...
      get_image_url: { Args: { file_path: string }; Returns: string }
      ...
      update_floor_image_dimensions: {
        Args: { p_floor_id: number; p_height: number; p_width: number }
        Returns: boolean
      }
      upgrade_point: {
        Args: { p_point_id: string; p_user_id: string }
